...
export function IconPhone({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.8 19.79 19.79 0 01.22 1.18 2 2 0 012.18 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.16 6.16l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/>
    </svg>
  );
}
...
export function IconFootball({ size = 28, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="16" cy="16" r="13" stroke={color} strokeWidth="1.5"/>
      <polygon points="16,8 19,12 17,17 15,17 13,12" fill={color} opacity="0.85"/>
      <line x1="16" x2="16" y1="3" y2="8" stroke={color} strokeWidth="1.5"/>
      <line x1="27.3" x2="19" y1="8.5" y2="12" stroke={color} strokeWidth="1.5"/>
      <line x1="23.5" x2="17" y1="26" y2="17" stroke={color} strokeWidth="1.5"/>
      <line x1="8.5" x2="15" y1="26" y2="17" stroke={color} strokeWidth="1.5"/>
      <line x1="4.7" x2="13" y1="8.5" y2="12" stroke={color} strokeWidth="1.5"/>
    </svg>
  );
}

export function IconCricket({ size = 28, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <line x1="8" y1="24" x2="22" y2="10" stroke={color} strokeWidth="2.5" strokeLinecap="round"/>
      <rect x="18.5" y="6" width="5" height="8" rx="1" transform="rotate(45 18.5 6)" fill={color} opacity="0.85" stroke={color} strokeWidth="1"/>
      <circle cx="9" cy="23" r="2.5" fill={color} opacity="0.7"/>
      <line x1="4" y1="27" x2="7" y2="27" stroke={color} strokeWidth="2" strokeLinecap="round"/>
      <line x1="5.5" x2="5.5" y1="25.5" y2="28.5" stroke={color} strokeWidth="2" strokeLinecap="round"/>
    </svg>
  );
}
...
export function IconNavigation({ size = 18, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
